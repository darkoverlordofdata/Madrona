...
CREATE TABLE IF NOT EXISTS `webzash_entries` (
...
CREATE TABLE IF NOT EXISTS `webzash_entry_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `webzash_entry_types` (
  `id` int(5) NOT NULL,
...
INSERT INTO webzash_groups (`id`, `parent_id`, `name`, `affects_gross`) VALUES (11, 3, 'Direct Funding', 1);
INSERT INTO webzash_groups (`id`, `parent_id`, `name`, `affects_gross`) VALUES (12, 4, 'Direct Expenses', 1);
INSERT INTO webzash_groups (`id`, `parent_id`, `name`, `affects_gross`) VALUES (13, 3, 'Indirect Funding', 0);
...
CREATE TABLE IF NOT EXISTS `webzash_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `webzash_settings` (
  `id` int(1) NOT NULL,
  `name` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `webzash_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
