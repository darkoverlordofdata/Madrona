...
$doc->addStyleSheet('/joomla/administrator/components/com_madrona/assets/css/style.css');
...
$doc->addStyleSheet('/joomla/administrator/components/com_madrona/assets/css/thickbox.css');
