...
<li><span class="qa-heading">General</span>
    ...
    <li><a href="#general-3" class="anchor-link-a">What is the Chart of Accounts based on ?</a></li>
	</ul>
</li>
...
<div class="qa-section" id="general-3">
    <a name="general-3"></a>
    <div class="qa-question">Q. What is the Chart of Accounts based on ?</div>
    <div class="qa-answer">Madrona's Chart of Accounts is based on UCOA Version 3 (see <a href='http://nccs.urban.org/projects/ucoa.cfm'>http://nccs.urban.org/projects/ucoa.cfm</a>)</div>
</div>
